...
// directive `reuse lint` parses the embedded license id as if it
...
const fn banner_pre_push() -> &'static str {
    "#!/usr/bin/env bash\n\
     ...
     # Copyright (c) 2025-2026 Acmex Placeholder LLC.\n\
     #\n\
     # AUTO-GENERATED by `scripts/ci/acmex-gen-hooks` from `scripts/ci/gates.toml`.\n\
...
"#,
    ...
    fn emit_target_default_output_paths_are_distinct() {
        // The drift-detector wires acmex-gen-hooks --check against the
