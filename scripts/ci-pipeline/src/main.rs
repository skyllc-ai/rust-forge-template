...
//
// ACMEX - acmex: High-Performance File Search Tool
// Contact: 50460704+acmex-owner@users.noreply.github.com for licensing
// inquiries.
...
async fn main() -> Result<()> {
    acmex_version::handle_version!("acmex-ci-pipeline");
    let cli = Cli::parse();
