# ACMEX Trademark Policy

> **Template notice.** This file is a TEMPLATE trademark policy, inherited
...
The ACMEX **source code** is licensed under the
...
You **can** do all of the following, with no permission needed and no
...
- **Call your own software "ACMEX," "acmex," or any
...
- **Register a domain name, trademark, social media handle, app store
  listing, or company name that contains "ACMEX" or
  "acmex."**
- **Claim or imply endorsement, partnership, or sponsorship** by ACMEX,
  Acmex Placeholder LLC, or the project maintainers.
...
1. **If you're shipping the upstream code with only mechanical changes**
   ...
   can keep the ACMEX name and logo. That's nominative use.
...
2. **If you're maintaining a long-lived fork with meaningful divergence**
   ...
   **rename it.** Pick something distinctive. Keep the ACMEX name *only*
   in factual references: "Fork of ACMEX," "Based on ACMEX," "Compatible
   with ACMEX." You cannot ship it *as* ACMEX.
...
|---|---|
| Blog post titled "How ACMEX works" | Yes |
| GitHub README linking to ACMEX | Yes |
...
[`trademark@acmex.example`](mailto:trademark@acmex.example).
...
- How much ACMEX branding will be visible and how long you expect to use
  it.
...
moves on. If they don't, Acmex Placeholder LLC reserves the right to pursue
...
- **Project:** <https://github.com/acmex-org/acmex>
- **Maintainer:** Acmex Placeholder Dev · [Acmex Placeholder LLC](https://github.com/acmex-org)
- **Email:** [`trademark@acmex.example`](mailto:trademark@acmex.example)
